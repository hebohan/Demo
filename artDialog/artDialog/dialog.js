...
var dialogAlert = function(msgAndTitle,okFun) {
     var title = "提示";
     var content = "";
     if (msgAndTitle){
    ...
    var html = '<div style="text-align:left;position: relative; width: 300px; height: 110px;">' +
                 '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">' +
                     '<tr><td align="right" style="width:50px;"><span class="icon_alert"></span></td>' +
                     '<td align="left" style="padding-left:10px;">' + content + '</td></tr>' +
                 '</table>' +
               '</div>';
    var alertDialog = dialog({ title: title, content: html, okValue: '确定', ok: okFun, cancel:false,fixed: true});
    alertDialog.showModal();
};
var dialogConfirm = function(msgAndTitle,okFun,centerFun){
     var title = "提示";
     var content = "";
     if (msgAndTitle){
        var msgAndTitleArr = msgAndTitle.split("|");
    ...
    var html = '<div style="text-align:left;position: relative; width: 300px; height: 110px;">' +
                 '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">' +
                     '<tr><td align="right" style="width:50px;"><span class="icon_query"></span></td>' +
                     '<td align="left" style="padding-left:10px;">' + content + '</td></tr>' +
                 '</table>' +
               '</div>';
    var alertDialog = dialog({ title: title, content: html, okValue: '确定', ok: okFun, cancelValue: '取消',cancel:centerFun,fixed: true});
    alertDialog.showModal();
};
